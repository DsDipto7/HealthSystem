...
//                     <button onClick={() => setActiveRoom(appt.room)}>Start Call</button>
//                   ) : (
//                     "Declined"
//                   )}
//                 </td>
...
//             }}
//           />
//           <button onClick={() => setActiveRoom(null)}>End Call</button>
//         </div>
//       )}
//     </div>
//   );
...
// 2ndly done without modification 
...
//                     </>
//                   ) : appt.status === "accepted" ? (
//                     <button onClick={() => setActiveRoom(appt.room)}>
//                       Start Call
//                     </button>
//                   ) : (
//                     <>Declined</>
...
//                       <button
//                         onClick={() =>
//                           navigate(`/videocall/${doctor.doctor_id}/${appt.id}`)
//                         }
//                       >
//                         Start Call
//                       </button>
...
//                       <span>Call Joined</span>
//                     ) : (
//                       <button onClick={() => handleStartCall(appt)}>
//                         Start Call
//                       </button>
//                     )
//                   ) : (
