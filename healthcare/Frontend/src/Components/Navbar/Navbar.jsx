...
//               {/* Example usage in a navbar or dropdown */}
...
//update:21/005/2025 and protected so taht it cannot modify other css
...
//   return (
//     <header className="template-navbar">
...
//             {isLoggedIn ? (
//               <>
//                 <li className="welcome-user">Hi, {username}</li>
//                 <li>
